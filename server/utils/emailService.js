      ...
      <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #0a0a0f; border-radius: 20px; overflow: hidden; border: 1px solid rgba(124,58,237,0.3);">
        ...
        <div style="padding: 30px; background: #16162a;">
          ...
          <div style="background: #0a0a0f; border: 2px solid rgba(124,58,237,0.4); border-radius: 16px; padding: 24px; text-align: center; margin: 20px 0;">
            ...
            <div style="font-size: 2.8rem; font-weight: 900; letter-spacing: 12px; color: #a855f7;">
              ${otp}
            </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0f; border-radius: 20px; overflow: hidden; border: 1px solid rgba(124,58,237,0.3);">
        ...
        <div style="background: #16162a; padding: 20px 28px 0;">
          ...
          <p style="color:#94a3b8; font-size:0.85rem; margin:6px 0 10px;">${new Date(order.createdAt).toLocaleString('en-IN')}</p>
          ${paymentBadge}
        ...
        <div style="background: #16162a; padding: 20px 28px;">
          ...
          <table style="width:100%; border-collapse:collapse;">
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:6px 0;">Product</td><td style="color:#f1f5f9;font-size:0.85rem;font-weight:700;text-align:right;">${product.name}</td></tr>
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:6px 0;">Quantity</td><td style="color:#f1f5f9;font-size:0.85rem;text-align:right;">${order.quantity}</td></tr>
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:6px 0;">Unit Price</td><td style="color:#f1f5f9;font-size:0.85rem;text-align:right;">${formatINR(product.price)}</td></tr>
            <tr style="border-top:1px solid rgba(255,255,255,0.07);"><td style="color:#10b981;font-size:1rem;font-weight:800;padding:10px 0 0;">Total</td><td style="color:#10b981;font-size:1rem;font-weight:800;text-align:right;padding-top:10px;">${formatINR(order.totalPrice)}</td></tr>
          </table>
        </div>
        <div style="background: #111118; padding: 20px 28px; border-top:1px solid rgba(255,255,255,0.05);">
          ...
          <table style="width:100%; border-collapse:collapse;">
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:5px 0;width:40%;">Name</td><td style="color:#f1f5f9;font-size:0.85rem;font-weight:600;">${buyer.name}</td></tr>
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:5px 0;">Email</td><td style="color:#f1f5f9;font-size:0.85rem;">${buyer.email}</td></tr>
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:5px 0;">Phone</td><td style="color:#f1f5f9;font-size:0.85rem;">${buyer.address?.phone || 'N/A'}</td></tr>
            <tr><td style="color:#94a3b8;font-size:0.85rem;padding:5px 0;vertical-align:top;">Address</td><td style="color:#f1f5f9;font-size:0.85rem;line-height:1.6;">${buyer.address?.street || ''}<br/>${buyer.address?.city || ''}, ${buyer.address?.state || ''} - ${buyer.address?.pincode || 'N/A'}</td></tr>
          </table>
        </div>
